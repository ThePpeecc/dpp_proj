let radix_sort_intragroup [n] (xs: [n]u32) : [n]u32 = 
  ...
  let radix_sort_MM [m] (xs : [m]u32) (b : u32) : [m]u32 =
    ...
    let kernel_1 = map (\bid -> 
      ...
      let radix = map (\elem -> i32.u32 (elem >> b*4 & mask)) data :> [block_size]i32  
    ...
    let scanned_block_d_sums = [0] ++ scan (+) 0 block_d_sums[:block_d_sums_length_m1]
